"""Stack-aware `doctor` for awstorage.
...
interesting failures live BETWEEN them. "awstorage is installed" is not the useful
fact -- "awstorage is installed and the thing it pairs with is not" is. This reports
...
PAIRS_WITH = ['adk', 'awgraph', 'awnode', 'awrecover']
...
#: gets ignored.
ENV_REQUIRED = []
ENV_OPTIONAL = ['AWSTORAGE_GATEWAY']
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awstorage needs at runtime, and a
